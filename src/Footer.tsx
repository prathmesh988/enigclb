...
const Footer: React.FC<Proptype> = ({ refss, refmain, reffooter }:Proptype) => {
  ...
  , []);
  return (
    <footer className="footer-section w-full bg-white text-black relative" ref={reffooter}>
            ...
            <div className="w-full lg:w-1/3 px-4 mb-12">
              <div className="footer-widget">
                ...
                <div className="footer-text text-[#7e7e7e] mb-8">
                  <p>
                  The IIST Research Conference, organized by students Of Indore Institute Of Science and
Technology, is a pivotal initiative to promote undergraduate research. This platform
allows students to engage in academic research typically reserved for postgraduates,
fostering critical thinking, problem-solving skills, and hands-on experience in scientific
methodology.
                  </p>
                </div>
                <div className="footer-social-icon">
                  ...
                  <a href="https://www.instagram.com/iist_research_conference/" className="text-[#878787] hover:text-[#ff5e14] mr-4">
              ...
              <div className="footer-widget">
                ...
                <ul className="flex flex-wrap">
                  <li className="w-1/2 mb-3">
                    <button  className="text-[#878787] hover:text-[#ff5e14] capitalize" onClick={
                     ()=>
                      {
                        window.scrollTo({
                          top: 0,
                  ...
                  <li className="w-1/2 mb-3">
                    <button  className="text-[#878787] hover:text-[#ff5e14] capitalize"
                    onClick={
                      ()=>
                      {
                  ...
                  <li className="w-1/2 mb-3">
                    <a href="https://www.site.uottawa.ca/~bochmann/Projects/how-to-do-good-research/index.html" className="text-[#878787] hover:text-[#ff5e14] capitalize"> How to do research in computer science</a>
                  </li>
                  
                  <li className="w-1/2 mb-3">
                    <a href="https://svr-sk818-web.cl.cam.ac.uk/keshav/papers/07/paper-reading.pdf" className="text-[#878787] hover:text-[#ff5e14] capitalize">How to read a paper</a>
                  </li>
                  <li className="w-1/2 mb-3">
                    <a href="#" className="text-[#878787] hover:text-[#ff5e14] capitalize">How to write a research paper - Microsoft Research:
                    </a>
                  </li>
            ...
            <div className="w-full lg:w-auto hidden lg:flex justify-end">
              <div className="footer-menu">
                <ul className="flex space-x-6">
                  <li>
                    <button  className="text-[#878787] hover:text-[#ff5e14]" onClick={()=>
